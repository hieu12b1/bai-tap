    ...
    <div class="container-xxl">
        ...
        <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
            <div class="flex-grow-1">
                <h4 class="fs-18 fw-semibold m-0">Quản lý mã sản phẩm sản phẩm</h4>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input disabled type="text" id="code" name="code"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="discount_type"
                                            ...
                                            <option value="{{ $discount_type['id'] }}"
                                                {{ $voucher->discount_type ==  $discount_type['id'] ? 'selected' : '' }}>
                                                {{ $discount_type['name'] }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="san_pham_id"
                                            ...
                                            <option value="{{ $product['id'] }}"
                                                {{ $voucher->san_pham_id == $product['id'] ? 'selected' : '' }}>
